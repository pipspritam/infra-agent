...
export default function RobotSVG({
  ...
  const a = ["Idle", "Reading", "Thinking", "Responding"].includes(act)
    ? act
    : "Idle";
  ...
  return (
    <svg
      ...
      viewBox="0 0 140 155"
      style={{
        filter: `drop-shadow(0 6px 16px color-mix(in srgb, ${ac} 22%, transparent))`,
      }}
    >
      {/* ── Treads ── */}
      <rect
